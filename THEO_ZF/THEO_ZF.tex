...
\begin{itemize}
	...
	\\\\ $\chi_K(w) = \chi_H(w,w)$ $\Leftrightarrow$ Da es für $M_w$ mit der Eingabe $w$ keine TM $M$ gibt, die entscheidet, ob $M_w$ hält; kann es auch die TM $M$ nicht geben, die für irgendeine TM $M_w$ bei irgendeiner Eingabe $x$ entscheidet, ob sie hält oder nicht.
\end{itemize}
